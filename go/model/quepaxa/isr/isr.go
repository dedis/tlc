...
// Proposal is an interface that defines method constraints
// that any proposal type P is expected to satisfy.
type Proposal[P any] interface {
	Nil() P                          // return a nil proposal of type P
	Best(other P) P                  // return the best of this proposal and other
	Rank(replica int, leader bool) P // randomly rank proposal
}
